...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 07 Agu 2021 pada 13.22
...
(298, '2021-07-30', '15:08:18', 1626747761, 5, 'Masuk', 'Absen melalui face', 'Absen Melalui Face Recognition', '2021-07-30 08:08:18', '2021-07-30 08:08:18'),
(299, '2021-08-02', '23:26:33', 1626747761, 5, 'Keluar', 'Absen melalui face', 'Absen Melalui Face Recognition', '2021-08-02 16:26:33', '2021-08-02 16:26:33'),
(300, '2021-08-03', '01:57:29', 1623238488, 5, 'Ijin', 'Ijin', 'ijin keluar', '2021-08-02 18:57:29', '2021-08-02 18:57:29'),
(301, '2021-08-04', '21:48:52', 1626747761, 5, 'Masuk', 'Absen Melalui Guru Piket', NULL, '2021-08-04 14:48:52', '2021-08-04 14:48:52'),
(302, '2021-08-02', '23:26:33', 1626747761, 5, 'Masuk', 'Absen melalui face', 'Absen Melalui Face Recognition', '2021-08-02 16:26:33', '2021-08-02 16:26:33'),
(303, '2021-08-04', '23:04:04', 1614326491, 5, 'Tidak hadir', 'Tidak hadir', 'tidak hadir', '2021-08-04 16:04:04', '2021-08-04 16:04:04'),
(304, '2021-08-05', '01:50:48', 1623238489, 5, 'Masuk', 'Absen Melalui Guru Piket', NULL, '2021-08-04 18:50:48', '2021-08-04 18:50:48'),
(305, '2021-08-05', '23:06:23', 1602863100, 5, 'Masuk', 'Absen Melalui Guru Piket', NULL, '2021-08-05 16:06:23', '2021-08-05 16:06:23');

-- --------------------------------------------------------

--
-- Struktur dari tabel `data_absen_matapelajaran`
--

CREATE TABLE `data_absen_matapelajaran` (
  `id` int(11) NOT NULL,
  `users_id` int(11) NOT NULL,
  `tgl_absen` varchar(20) NOT NULL,
  `jam_absen` varchar(25) NOT NULL,
  `status` varchar(25) NOT NULL,
  `deskripsi` varchar(50) NOT NULL,
  `setting_master_materi_id` int(11) NOT NULL,
  `setting_materi_pertemuan_id` int(11) NOT NULL,
...
--
-- Dumping data untuk tabel `data_absen_matapelajaran`
--

INSERT INTO `data_absen_matapelajaran` (`id`, `users_id`, `tgl_absen`, `jam_absen`, `status`, `deskripsi`, `setting_master_materi_id`, `setting_materi_pertemuan_id`, `keterangan`, `created_at`, `updated_at`) VALUES
(24, 1623238489, '2021-08-03', '14:33:51', 'Masuk', 'Absen melalui guru', 7, 32, 'Absen melalui guru', '2021-08-03 07:33:51', '2021-08-03 07:33:51'),
(25, 1623238488, '2021-08-03', '14:34:27', 'Ijin', 'Ijin', 7, 32, 'ijin', '2021-08-03 07:34:27', '2021-08-03 07:34:27'),
(26, 1623238489, '2021-08-03', '14:35:08', 'Sakit', 'Sakit', 7, 30, 'sakit', '2021-08-03 07:35:08', '2021-08-03 07:35:08'),
(27, 1623238488, '2021-08-03', '14:35:39', 'Tidak hadir', 'Tidak hadir', 6, 33, 'tidak hadir', '2021-08-03 07:35:39', '2021-08-03 07:35:39'),
(28, 1626747761, '2021-08-03', '14:48:40', 'Masuk', 'Absen melalui wajah', 6, 33, 'Absen Melalui Face Recognition', '2021-08-03 07:48:40', '2021-08-03 07:48:40'),
(29, 1623238488, '2021-08-03', '20:53:50', 'Masuk', 'Absen melalui guru', 6, 20, 'Absen melalui guru', '2021-08-03 13:53:50', '2021-08-03 13:53:50'),
(30, 1602863104, '2021-08-06', '20:33:17', 'Masuk', 'Absen melalui guru', 8, 35, 'Absen melalui guru', '2021-08-06 13:33:17', '2021-08-06 13:33:17');
...
--
-- Dumping data untuk tabel `data_isi_materi`
--

INSERT INTO `data_isi_materi` (`id`, `data_judul_materi_id`, `file`, `path`, `judul`, `isi_materi`, `isi_pertanyaan`, `type`, `created_at`, `updated_at`) VALUES
(15, 4, NULL, '', 'materi 1', '<p>isi materi 1</p>', NULL, 'materi', '2021-07-30 15:57:01', '2021-07-30 15:57:01'),
(16, 4, NULL, '', 'pertanyaan 1', NULL, 'isi pertanyaan 1', 'pertanyaan', '2021-07-30 15:57:25', '2021-07-30 15:57:25'),
(17, 4, NULL, 'images/isimateri/', 'materi 2', '<p>dsadasdsa</p>', NULL, 'materi', '2021-07-30 16:12:16', '2021-07-30 16:12:16'),
(18, 4, NULL, 'images/isimateri/', 'materi 3', '<p>dsadas</p>', NULL, 'materi', '2021-07-30 16:15:34', '2021-07-30 16:15:34'),
(19, 4, '1627662027-Capture1.PNG', 'images/isimateri/', 'materi 4', '<p>isi materi 4	</p><p><br></p><p>dsadada</p><p><br></p><p><br></p><p>dasdada</p>', NULL, 'materi', '2021-07-30 16:20:27', '2021-07-30 16:20:27'),
(20, 4, '1627662227-Capture1.PNG', 'images/isimateri/', 'pertanyaan 2', NULL, 'sadsa', 'pertanyaan', '2021-07-30 16:23:47', '2021-07-30 16:23:47'),
(21, 5, NULL, 'images/isimateri/', 'a', '<p>ghgjhghjgjhgjh</p>', NULL, 'materi', '2021-08-06 10:53:04', '2021-08-06 10:53:04'),
(22, 5, NULL, 'images/isimateri/', 'b', '<p>uyffhgfghfh</p>', NULL, 'materi', '2021-08-06 10:53:12', '2021-08-06 10:53:12'),
(23, 5, NULL, 'images/isimateri/', 'c', '<p>ghjghjgjh</p>', NULL, 'materi', '2021-08-06 10:53:20', '2021-08-06 10:53:20'),
(24, 5, NULL, 'images/isimateri/', 'd', NULL, 'fggjhk', 'pertanyaan', '2021-08-06 10:53:34', '2021-08-06 10:53:34');
...
--
-- Struktur dari tabel `data_jawaban_evaluasi`
--

CREATE TABLE `data_jawaban_evaluasi` (
  `id` int(11) NOT NULL,
  `setting_soal_evaluasi_id` int(11) NOT NULL,
...
--
-- Struktur dari tabel `data_jawaban_materi_pembelajaran`
--

CREATE TABLE `data_jawaban_materi_pembelajaran` (
  `id` int(11) NOT NULL,
  `setting_master_materi_id` int(11) NOT NULL,
  `setting_materi_pertemuan_id` int(11) NOT NULL,
  `users_id` int(11) NOT NULL,
  `data_isi_materi_id` int(11) NOT NULL,
...
--
-- Dumping data untuk tabel `data_jawaban_materi_pembelajaran`
--

INSERT INTO `data_jawaban_materi_pembelajaran` (`id`, `setting_master_materi_id`, `setting_materi_pertemuan_id`, `users_id`, `data_isi_materi_id`, `jawaban`, `created_at`, `updated_at`) VALUES
(7, 7, 32, 1623238489, 16, 'jawaban pertanyaan 11', '2021-08-03 17:16:45', '2021-08-03 17:25:29'),
(8, 7, 32, 1623238489, 20, 'jawaban pertenyaan 22', '2021-08-03 17:26:01', '2021-08-03 17:26:14'),
(9, 8, 35, 1602863104, 24, 'dsa', '2021-08-06 13:34:23', '2021-08-06 13:34:23');
...
--
-- Struktur dari tabel `data_jawaban_ujian_materi_pembelajaran`
--

CREATE TABLE `data_jawaban_ujian_materi_pembelajaran` (
  `id` int(11) NOT NULL,
  `setting_materi_pertemuan_id` int(11) NOT NULL,
  `data_master_soal_id` int(11) NOT NULL,
  `data_soal_id` int(11) NOT NULL,
...
--
-- Dumping data untuk tabel `data_jawaban_ujian_materi_pembelajaran`
--

INSERT INTO `data_jawaban_ujian_materi_pembelajaran` (`id`, `setting_materi_pertemuan_id`, `data_master_soal_id`, `data_soal_id`, `users_id`, `data_soal_jawaban_id`, `is_right`, `file`, `jawaban_essay`, `created_at`, `updated_at`) VALUES
(1, 20, 2, 18, 1623238489, 5, 'Benar', NULL, NULL, '2021-07-31 09:18:50', '2021-07-31 09:25:46'),
(3, 20, 2, 23, 1623238489, 3, 'Salah', NULL, NULL, '2021-07-31 09:22:58', '2021-07-31 09:22:58'),
(4, 20, 2, 15, 1623238489, 5, 'Salah', NULL, NULL, '2021-07-31 09:23:08', '2021-07-31 09:23:08'),
(5, 20, 2, 16, 1623238489, NULL, 'Salah', NULL, NULL, '2021-07-31 09:23:16', '2021-07-31 09:23:16'),
(6, 20, 2, 24, 1623238489, 5, 'Salah', NULL, NULL, '2021-07-31 09:23:49', '2021-07-31 09:23:49'),
(7, 20, 2, 20, 1623238489, NULL, NULL, '', 'dsadasas', '2021-07-31 09:24:29', '2021-07-31 09:24:29'),
(8, 20, 2, 19, 1623238489, NULL, NULL, '1627723481-download.png', 'dsaasdasd', '2021-07-31 09:24:41', '2021-07-31 09:24:41');
...
(3, 1626277979, 'bab 1', 'dasdadada', 'dribbble', '2021-07-27 17:35:18', '2021-07-27 17:35:18'),
(4, 1626277973, 'B. inggris 1', 'bahasa inggris 1', 'book', '2021-07-28 09:54:13', '2021-07-28 09:54:13'),
(5, 1626277985, 'Bab 1', 'berisikan tentang pengenalan web', 'book', '2021-08-06 10:27:43', '2021-08-06 10:27:43');
...
(1626277979, 1626748647, '1627406141-Capture1.PNG', 'dsa', 'dsa', 'dsa', '2021-07-27 17:15:41', '2021-07-27 17:15:41'),
(1626277980, 1626748647, '1627406599-download.png', '32', '2', '32', '2021-07-27 17:23:19', '2021-07-27 17:23:19'),
(1626277981, 1626748647, '1627406920-Capture.PNG', 'sa', 'sa', 'sa', '2021-07-27 17:28:40', '2021-07-27 17:28:40'),
(1626277982, 1626748647, '1627406938-downloadm.png', 'sa', 'sa', 'sa', '2021-07-27 17:28:58', '2021-07-27 17:28:58'),
(1626277984, 1626748647, '1627407276-Untitled.png', 'sdad', 'dsda', 'dsada', '2021-07-27 17:34:36', '2021-07-27 17:34:36'),
(1626277985, 1614326491, '1628245631-Capture.PNG', 'pemrograman web', 'pemrograman web', 'program', '2021-08-06 10:27:11', '2021-08-06 10:27:11');
...
(7, 3, 'Kuesioner', 'kuesioner', 1, 1, '1628265584-Capture1.PNG', '2021-08-06 15:59:44', '2021-08-06 15:59:44'),
(8, 3, 'kuesioner 2', 'dsa', NULL, 1, '1628269178-Capture.PNG', '2021-08-06 16:59:38', '2021-08-06 16:59:38');
...
--
-- Struktur dari tabel `data_nilai_pertemuan`
--

CREATE TABLE `data_nilai_pertemuan` (
  `id` int(11) NOT NULL,
  `setting_master_materi_id` int(11) NOT NULL,
  `setting_materi_pertemuan_id` int(11) NOT NULL,
  `users_id` int(11) NOT NULL,
...
--
-- Dumping data untuk tabel `data_nilai_pertemuan`
--

INSERT INTO `data_nilai_pertemuan` (`id`, `setting_master_materi_id`, `setting_materi_pertemuan_id`, `users_id`, `nilai`, `created_at`, `updated_at`) VALUES
(1, 7, 17, 1623238489, 90, '2021-08-03 18:11:43', '2021-08-03 18:11:43'),
(3, 7, 32, 1623238489, 98, '2021-08-03 18:39:25', '2021-08-03 18:41:21');
...
--
-- Struktur dari tabel `data_nilai_ujian_materi_pembelajaran`
--

CREATE TABLE `data_nilai_ujian_materi_pembelajaran` (
  `id` int(11) NOT NULL,
  `setting_materi_pertemuan_id` int(11) NOT NULL,
  `users_id` int(11) NOT NULL,
  `nilai` int(11) NOT NULL,
...
--
-- Dumping data untuk tabel `data_nilai_ujian_materi_pembelajaran`
--

INSERT INTO `data_nilai_ujian_materi_pembelajaran` (`id`, `setting_materi_pertemuan_id`, `users_id`, `nilai`, `nilai_essay`, `created_at`, `updated_at`) VALUES
(1, 20, 1623238489, 3, 0, '2021-07-31 09:19:10', '2021-07-31 09:25:46');
...
(25, 2, 'dsa', '1627726106-Track-55 20210414-014156.m4a', 2, 1, '1', NULL, '2021-07-31 10:08:27', '2021-07-31 10:08:27'),
(26, 2, 'soal audio', '1627726625-Track-55 20210414-014156.m4a', 2, 1, '1', NULL, '2021-07-31 10:17:05', '2021-07-31 10:17:05'),
(27, 2, 'esay audio', '1627726984-Track-55 20210414-014156.m4a', NULL, NULL, '2', NULL, '2021-07-31 10:23:04', '2021-07-31 10:23:04'),
(28, 2, 'video', '1627727576-screen-20210413-231640.mp4', 2, 1, '1', NULL, '2021-07-31 10:32:56', '2021-07-31 10:32:56'),
(29, 7, 'bagaimana pendapat kamu tentang materi pengajaran?', '', 2, 1, '1', NULL, '2021-08-06 16:01:38', '2021-08-06 16:01:38'),
(30, 7, 'Bagaimana pendapat kamu tentang cara guru mengajar?', '', 2, 1, '1', NULL, '2021-08-06 16:03:09', '2021-08-06 16:03:09'),
(31, 7, 'Berikan pendapat kamu tentang pengajaran dan guru terkait!!', '', NULL, NULL, '2', NULL, '2021-08-06 16:03:55', '2021-08-06 16:03:55'),
(32, 8, 'a', '', 2, 1, '1', NULL, '2021-08-06 17:00:03', '2021-08-06 17:00:03');
...
(46, 25, 'dsa', '', 1, '2021-07-31 10:08:27', '2021-07-31 10:08:27'),
(47, 25, 'dsa', '', 2, '2021-07-31 10:08:27', '2021-07-31 10:08:27'),
(48, 25, 'das', '', 3, '2021-07-31 10:08:27', '2021-07-31 10:08:27'),
(49, 25, 'das', '', 4, '2021-07-31 10:08:27', '2021-07-31 10:08:27'),
(50, 25, 'das', '', 5, '2021-07-31 10:08:27', '2021-07-31 10:08:27'),
(51, 26, 'audio', '1627726625-Track-55 20210414-014156.m4a', 1, '2021-07-31 10:17:05', '2021-07-31 10:17:05'),
(52, 26, 'dsadsa', '', 2, '2021-07-31 10:17:05', '2021-07-31 10:17:05'),
(53, 26, 'das', '1627726625-download.png', 3, '2021-07-31 10:17:05', '2021-07-31 10:17:05'),
(54, 26, 'dasdas', '', 4, '2021-07-31 10:17:05', '2021-07-31 10:17:05'),
(55, 26, 'das', '', 5, '2021-07-31 10:17:05', '2021-07-31 10:17:05'),
(56, 28, 'video', '1627727576-screen-20210413-231640.mp4', 1, '2021-07-31 10:32:56', '2021-07-31 10:32:56'),
(57, 28, 'da', '', 2, '2021-07-31 10:32:56', '2021-07-31 10:32:56'),
(58, 28, 'dsa', '', 3, '2021-07-31 10:32:56', '2021-07-31 10:32:56'),
(59, 28, 'dsa', '', 4, '2021-07-31 10:32:56', '2021-07-31 10:32:56'),
(60, 28, 'das', '', 5, '2021-07-31 10:32:56', '2021-07-31 10:32:56'),
(61, 29, 'sangat sesuai', '', 1, '2021-08-06 16:01:38', '2021-08-06 16:01:38'),
(62, 29, 'sesuai', '', 2, '2021-08-06 16:01:38', '2021-08-06 16:01:38'),
(63, 29, 'tidak sesuai', '', 3, '2021-08-06 16:01:38', '2021-08-06 16:01:38'),
(64, 29, 'sangat tidak sesuai', '', 4, '2021-08-06 16:01:38', '2021-08-06 16:01:38'),
(65, 29, 'saya tidak mengikuti', '', 5, '2021-08-06 16:01:38', '2021-08-06 16:01:38'),
(66, 30, 'sangat sesuai', '', 1, '2021-08-06 16:03:09', '2021-08-06 16:03:09'),
(67, 30, 'sesuai', '', 2, '2021-08-06 16:03:09', '2021-08-06 16:03:09'),
(68, 30, 'tidak sesuai', '', 3, '2021-08-06 16:03:09', '2021-08-06 16:03:09'),
(69, 30, 'sangat tidak sesuai', '', 4, '2021-08-06 16:03:09', '2021-08-06 16:03:09'),
(70, 30, 'tidak mengikuti', '', 5, '2021-08-06 16:03:09', '2021-08-06 16:03:09'),
(71, 32, 'a', '', 1, '2021-08-06 17:00:03', '2021-08-06 17:00:03'),
(72, 32, 'a', '', 2, '2021-08-06 17:00:03', '2021-08-06 17:00:03'),
(73, 32, 'a', '', 3, '2021-08-06 17:00:03', '2021-08-06 17:00:03'),
(74, 32, 'a', '', 4, '2021-08-06 17:00:03', '2021-08-06 17:00:03'),
(75, 32, 'a', '', 5, '2021-08-06 17:00:03', '2021-08-06 17:00:03');
...
(26, '12:00', '23:00', '2021-08-05 16:16:21', '2021-08-05 16:16:21');
...
(22, 22894, 1623238489, 5, '2021-07-16 23:58:42', '2021-07-29 10:51:34'),
(34, 22894, 1623238488, 5, '2021-07-17 08:13:46', '2021-07-31 17:33:43'),
...
(3, 1614326491, 4, 22893, 5, 'Senin', '13:29', '14:29', 1, '2021-07-22 23:29:38', '2021-07-27 20:58:19'),
(4, 1626748647, 4, 22895, 5, 'Senin', '04:59', '06:01', 1, '2021-07-27 20:58:12', '2021-07-27 20:58:19'),
(5, 1626747761, 3, 22898, 5, 'Senin', '02:02', '03:03', 1, '2021-08-06 14:33:42', '2021-08-06 14:33:53');
...
--
-- Struktur dari tabel `setting_master_materi`
--

CREATE TABLE `setting_master_materi` (
  `id` int(11) NOT NULL,
  `data_master_materi_id` int(11) NOT NULL,
  `setting_kontrak_pengajaran_id` int(11) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
...
--
-- Dumping data untuk tabel `setting_master_materi`
--

INSERT INTO `setting_master_materi` (`id`, `data_master_materi_id`, `setting_kontrak_pengajaran_id`, `created_at`, `updated_at`) VALUES
(6, 1626277977, 2, '2021-07-29 10:18:11', '2021-07-30 17:01:01'),
(7, 1626277973, 1, '2021-07-29 10:18:42', '2021-07-30 16:58:48'),
(8, 1626277985, 3, '2021-08-06 10:53:57', '2021-08-06 10:53:57'),
(9, 1626277979, 4, '2021-08-06 15:04:35', '2021-08-06 15:04:35');

-- --------------------------------------------------------

--
-- Struktur dari tabel `setting_materi_pertemuan`
--

CREATE TABLE `setting_materi_pertemuan` (
  `id` int(11) NOT NULL,
  `judul` varchar(250) NOT NULL,
  `deskripsi` text NOT NULL,
  `tgl` varchar(20) NOT NULL,
  `jam` varchar(20) NOT NULL,
  `setting_master_materi_id` int(11) DEFAULT NULL,
  `data_judul_materi_id` int(11) DEFAULT NULL,
  `data_master_soal_id` int(11) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data untuk tabel `setting_materi_pertemuan`
--

INSERT INTO `setting_materi_pertemuan` (`id`, `judul`, `deskripsi`, `tgl`, `jam`, `setting_master_materi_id`, `data_judul_materi_id`, `data_master_soal_id`, `created_at`, `updated_at`) VALUES
(17, 'pertemuan 1', 'sdapdsapdapdasppadpad', '2021-07-30', '23:59:34', 7, 4, NULL, '2021-07-30 16:59:34', '2021-07-30 16:59:34'),
(20, 'latihan', 'latihan', '2021-07-31', '03:01:01', 6, NULL, 2, '2021-07-30 20:01:01', '2021-07-30 20:01:01'),
(21, 'dsadsa', 'dsadsa', '2021-08-03', '00:16:43', 7, NULL, 2, '2021-08-02 17:16:43', '2021-08-02 17:16:43'),
(22, 'trrrert', 'rtrt', '2021-08-03', '00:19:15', 7, 4, NULL, '2021-08-02 17:19:15', '2021-08-02 17:19:15'),
(23, 'pertemuan 5', 'sa', '2021-08-03', '00:19:41', 7, 4, NULL, '2021-08-02 17:19:41', '2021-08-02 17:19:41'),
(24, 'pertemuan 6', 'sada', '2021-08-03', '00:19:55', 7, 4, NULL, '2021-08-02 17:19:55', '2021-08-02 17:19:55'),
(25, 'pertemuan 7', 'dsa', '2021-08-03', '00:20:17', 7, 4, NULL, '2021-08-02 17:20:17', '2021-08-02 17:20:17'),
(26, 'pertemuan 8', 'sdada', '2021-08-03', '00:20:31', 7, 4, NULL, '2021-08-02 17:20:31', '2021-08-02 17:20:31'),
(27, 'pertemuan 9', 'sda', '2021-08-03', '00:22:17', 7, 4, NULL, '2021-08-02 17:22:17', '2021-08-02 17:22:17'),
(28, 'pertemuan 10', 'dsa', '2021-08-03', '00:22:31', 7, 4, NULL, '2021-08-02 17:22:31', '2021-08-02 17:22:31'),
(29, 'pertemuan 11', 'dsa', '2021-08-03', '00:22:46', 7, 4, NULL, '2021-08-02 17:22:46', '2021-08-02 17:22:46'),
(30, 'pertemuan 12', 'dsa', '2021-08-03', '00:28:41', 7, 4, NULL, '2021-08-02 17:28:41', '2021-08-02 17:28:41'),
(31, 'pertemuan 13', 'dsa', '2021-08-03', '00:28:56', 7, 4, NULL, '2021-08-02 17:28:56', '2021-08-02 17:28:56'),
(32, 'pertemuan 14', 'das', '2021-08-03', '00:29:17', 7, 4, NULL, '2021-08-02 17:29:17', '2021-08-02 17:29:17'),
(33, 'pertemuan 2', 'dsa', '2021-08-03', '01:13:48', 6, NULL, 5, '2021-08-02 18:13:48', '2021-08-02 18:13:48'),
(34, 'try', 'hfhg', '2021-08-03', '20:58:10', 6, 2, NULL, '2021-08-03 13:58:10', '2021-08-03 13:58:10'),
(35, 'pertemuan 1', 'jkhlkjl', '2021-08-06', '17:54:22', 8, 5, NULL, '2021-08-06 10:54:22', '2021-08-06 10:54:22'),
(36, 'rwqq', 'ada', '2021-08-06', '22:10:48', 9, 3, NULL, '2021-08-06 15:10:48', '2021-08-06 15:10:48');

-- --------------------------------------------------------

--
-- Struktur dari tabel `setting_soal_evaluasi`
--

CREATE TABLE `setting_soal_evaluasi` (
  `id` int(11) NOT NULL,
  `data_master_soal_id` int(11) NOT NULL,
  `is_active` int(11) DEFAULT NULL,
...
(1602863100, NULL, NULL, 'guru', 'ktp-4.jpeg', 'guru@gmail.com', NULL, '1', '0838371444', '$2y$10$/50MXxCKZpi1XjHqKWh3MOldLpj6wcRy4wFjJkXd85aVQyHk3pa7e', 'desa suci blok tenggeran mundu cirebon', NULL, 8, 1, '1613648446', NULL, 2, NULL, '2020-10-08 14:23:15', '2021-07-30 07:58:08'),
...
(140, 8, 18, '2021-08-05 16:23:51', '2021-08-05 16:23:51'),
(141, 8, 19, '2021-08-05 16:23:51', '2021-08-05 16:23:51'),
(142, 8, 21, '2021-08-05 16:23:51', '2021-08-05 16:23:51'),
(143, 8, 22, '2021-08-05 16:23:51', '2021-08-05 16:23:51'),
(144, 1, 6, '2021-08-06 15:50:31', '2021-08-06 15:50:31'),
(145, 1, 8, '2021-08-06 15:50:31', '2021-08-06 15:50:31'),
(146, 1, 15, '2021-08-06 15:50:31', '2021-08-06 15:50:31'),
(147, 1, 16, '2021-08-06 15:50:31', '2021-08-06 15:50:31'),
(148, 1, 17, '2021-08-06 15:50:31', '2021-08-06 15:50:31'),
(149, 1, 20, '2021-08-06 15:50:31', '2021-08-06 15:50:31');
...
(10, 'Alumni', NULL, NULL),
(11, 'Guru Piket', '2021-07-19 09:36:12', '2021-07-19 09:36:12');
...
(21, 25, 'Master Soal', '2021-08-06 15:52:18', '2021-08-06 15:52:18', '/mastersoal'),
(22, 25, 'Setting Soal Evaluasi', '2021-08-06 15:54:23', '2021-08-06 15:54:23', '/evaluasi');
...
(264, 19, 'Absen Pengajaran', '/absenpengajaran', 'user-check', '2021-07-05 08:22:12', '2021-07-05 08:22:12'),
...
--
-- Indeks untuk tabel `data_absen_matapelajaran`
--
ALTER TABLE `data_absen_matapelajaran`
  ADD PRIMARY KEY (`id`),
  ADD KEY `users_id` (`users_id`),
  ADD KEY `setting_materi_pertemuan_id` (`setting_materi_pertemuan_id`);
...
--
-- Indeks untuk tabel `data_jawaban_evaluasi`
--
ALTER TABLE `data_jawaban_evaluasi`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `data_jawaban_materi_pembelajaran`
--
ALTER TABLE `data_jawaban_materi_pembelajaran`
  ADD PRIMARY KEY (`id`);
...
--
-- Indeks untuk tabel `data_jawaban_ujian_materi_pembelajaran`
--
ALTER TABLE `data_jawaban_ujian_materi_pembelajaran`
  ADD PRIMARY KEY (`id`);
...
--
-- Indeks untuk tabel `data_nilai_pertemuan`
--
ALTER TABLE `data_nilai_pertemuan`
  ADD PRIMARY KEY (`id`);
...
--
-- Indeks untuk tabel `data_nilai_ujian_materi_pembelajaran`
--
ALTER TABLE `data_nilai_ujian_materi_pembelajaran`
  ADD PRIMARY KEY (`id`);
...
--
-- Indeks untuk tabel `setting_master_materi`
--
ALTER TABLE `setting_master_materi`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `setting_materi_pertemuan`
--
ALTER TABLE `setting_materi_pertemuan`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `setting_soal_evaluasi`
--
ALTER TABLE `setting_soal_evaluasi`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT untuk tabel `data_absen_matapelajaran`
--
ALTER TABLE `data_absen_matapelajaran`
...
--
-- AUTO_INCREMENT untuk tabel `data_jawaban_evaluasi`
--
ALTER TABLE `data_jawaban_evaluasi`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `data_jawaban_materi_pembelajaran`
--
ALTER TABLE `data_jawaban_materi_pembelajaran`
...
--
-- AUTO_INCREMENT untuk tabel `data_jawaban_ujian_materi_pembelajaran`
--
ALTER TABLE `data_jawaban_ujian_materi_pembelajaran`
...
--
ALTER TABLE `data_master_materi`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1626277986;
...
--
-- AUTO_INCREMENT untuk tabel `data_nilai_pertemuan`
--
ALTER TABLE `data_nilai_pertemuan`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT untuk tabel `data_nilai_ujian_materi_pembelajaran`
--
ALTER TABLE `data_nilai_ujian_materi_pembelajaran`
...
--
-- AUTO_INCREMENT untuk tabel `setting_master_materi`
--
ALTER TABLE `setting_master_materi`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT untuk tabel `setting_materi_pertemuan`
--
ALTER TABLE `setting_materi_pertemuan`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT untuk tabel `setting_soal_evaluasi`
--
ALTER TABLE `setting_soal_evaluasi`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- Ketidakleluasaan untuk tabel `data_absen_matapelajaran`
--
ALTER TABLE `data_absen_matapelajaran`
  ADD CONSTRAINT `data_absen_matapelajaran_ibfk_1` FOREIGN KEY (`setting_materi_pertemuan_id`) REFERENCES `setting_materi_pertemuan` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
